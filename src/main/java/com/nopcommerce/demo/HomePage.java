...
public class HomePage extends Utils {
    ...
    public void clickOnAnyProductOnHomePage() {
        ...
        enter_Text(enterFriendEmailAddress, "bhavin" + date_Stamp() + "patel@gmail.com");}
        public void enterUsersEmailAddress(){
        //users email address
        enter_Text(enterUsersEmailAddress, "sandippatel36@gmail.com");}
        public void messageToFriend(){
        //string message
        enter_Text(messageToFriend, "this is good product");}
